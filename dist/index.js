...
// data/iso-4217/list-one.json
var list_one_default = {
  ...
  currencies: [
    ...
    },
    {
      ...
      countries: [
        "International Monetary Fund (Imf)\xA0"
      ]
    },
    {
      code: "XOF",
...
// src/index.ts
var data = list_one_default.currencies;
var publishDate = list_one_default.publishDate;
var code = (code2) => {
...
var country = (country2) => {
  ...
  return data.filter((c) => {
    return (c.countries.map((c2) => c2.toLowerCase()) || []).indexOf(country2) > -1;
  });
};
var number = (number2) => {
  return data.find((c) => {
